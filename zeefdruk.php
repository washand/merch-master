<?php
$PAGE_TITLE = 'Zeefdruk';
$PAGE_DESC  = 'Alles over zeefdruk bij Merch Master. Duurzame bedrukking voor grote oplages vanaf 25 stuks.';
...
<section style="padding:4rem 2.5rem 5rem;">
  <div class="container">
    <div class="sec-kop" style="text-align:left;margin-bottom:2.5rem;">
      ...
      <h2 style="font-size:clamp(2.2rem,5vw,3.2rem);"><em><?= t('zeef_naam') ?></em></h2>
      <p style="font-size:1.05rem;color:var(--ink2);line-height:1.75;max-width:600px;margin-top:.75rem;"><?= t('zeef_txt') ?></p>
    </div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:2rem;margin-bottom:3rem;" class="fade-in">
      <img src="/img/zeefdruk.jpg" alt="Zeefdruk machine" style="width:100%;height:300px;object-fit:cover;border-radius:12px;">
      <img src="/img/zeefdruk2.jpg" alt="Zeefdruk resultaat" style="width:100%;height:300px;object-fit:cover;border-radius:12px;">
    </div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1.5rem;margin-bottom:3rem;" class="fade-in">
      <div style="background:rgba(58,90,64,.08);border-radius:10px;padding:1.5rem;">
        ...
        <ul style="list-style:none;display:flex;flex-direction:column;gap:.5rem;">
          <li style="font-size:.85rem;color:var(--ink2);"><?= t('zeef_v1') ?></li>
          <li style="font-size:.85rem;color:var(--ink2);"><?= t('zeef_v2') ?></li>
          <li style="font-size:.85rem;color:var(--ink2);"><?= t('zeef_v3') ?></li>
          <li style="font-size:.85rem;color:var(--ink2);"><?= t('zeef_v4') ?></li>
        </ul>
      </div>
      <div style="background:rgba(192,57,43,.06);border-radius:10px;padding:1.5rem;">
        ...
        <ul style="list-style:none;display:flex;flex-direction:column;gap:.5rem;">
          <li style="font-size:.85rem;color:var(--ink2);"><?= t('zeef_n1') ?></li>
          <li style="font-size:.85rem;color:var(--ink2);"><?= t('zeef_n2') ?></li>
          <li style="font-size:.85rem;color:var(--ink2);"><?= t('zeef_n3') ?></li>
        </ul>
      </div>
      <div style="background:var(--zand);border-radius:10px;padding:1.5rem;">
        ...
        <ul style="list-style:none;display:flex;flex-direction:column;gap:.5rem;">
          <li style="font-size:.85rem;color:var(--ink2);"><?= t('zeef_t1') ?></li>
          <li style="font-size:.85rem;color:var(--ink2);"><?= t('zeef_t2') ?></li>
          <li style="font-size:.85rem;color:var(--ink2);"><?= t('zeef_t3') ?></li>
          <li style="font-size:.85rem;color:var(--ink2);"><?= t('zeef_t4') ?></li>
          <li style="font-size:.85rem;color:var(--ink2);"><?= t('zeef_t5') ?></li>
        </ul>
      </div>
    </div>
    <div style="background:var(--kaart);border:1px solid rgba(196,98,45,.12);border-radius:12px;padding:2rem;margin-bottom:2rem;" class="fade-in">
      <h3 style="font-family:var(--display);font-size:1.4rem;margin-bottom:.75rem;"><?= t('zeef_hoe_h') ?></h3>
      <p style="color:var(--ink2);line-height:1.8;margin-bottom:1rem;"><?= t('zeef_hoe_1') ?></p>
      <p style="color:var(--ink2);line-height:1.8;"><?= t('zeef_hoe_2') ?></p>
    </div>
